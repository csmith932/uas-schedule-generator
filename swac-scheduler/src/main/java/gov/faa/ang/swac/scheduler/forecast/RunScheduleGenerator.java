...
import gov.faa.ang.swac.scheduler.data.ASPMTaxiTimes.ASPMTaxiTimesRecord;
import gov.faa.ang.swac.scheduler.forecast.airport_data.CountryRegionHash.CountryRegionRecord;
import gov.faa.ang.swac.scheduler.forecast.airport_data.ForecastAirportCountsRecord;
...
public final class RunScheduleGenerator extends CloneableAbstractTask {

    private static final org.apache.log4j.Logger logger =
            org.apache.log4j.LogManager.getLogger(RunScheduleGenerator.class);
    ...
    public RunScheduleGenerator() {  }

    private RunScheduleGenerator(RunScheduleGenerator b) {
    	super(b);
    ...
    @Override
    public RunScheduleGenerator clone() {
        return new RunScheduleGenerator(this);
    }
