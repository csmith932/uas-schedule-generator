...
//{
//	public static WayPoint dummy(int seed)
//	{
...
//		}
//
//		WayPoint point = new WayPoint(Latitude.valueOfDegrees(seed), Longitude.valueOfDegrees(seed+10.0));
//		point.setName(name);
...
//	{
//		System.out.println("================================================================================");
//		System.out.println("Unit tests for WayPoint.toString & WayPoint.fromTextRecord() & WayPoint.clone():");
//
//		for (int i=0; i<5; i++)
//		{
//			WayPoint original = WayPointTest.dummy(i); // Create a dummy object
//			WayPoint copy = WayPoint.fromTextRecord(original.toString()); // Convert it to String and back
//			WayPoint clone = original.clone();
...
//	{
//		org.junit.runner.JUnitCore.runClasses(WayPointTest.class);
//	}
//}