...
public class ExponentialDistribution extends ContinuousDistribution {
   ...
   /**
    * Constructs an <TT>ExponentialDistribution</TT> object with parameter <SPAN CLASS="MATH"><I>&#955;</I></SPAN> = 1.
    * 
    */
   ...
   /**
    * Constructs an <TT>ExponentialDistribution</TT> object with parameter <SPAN CLASS="MATH"><I>&#955;</I></SPAN> =
    *   <TT>lambda</TT>.
    * 
    */
   ...
   public double nextDouble (Random rng) {
      return inverseF (lambda, rng.nextDouble());
   }

   public double getMean() {
      return ExponentialDistribution.getMean (lambda);
   }

   public double getVariance() {
      return ExponentialDistribution.getVariance (lambda);
   }

   public double getStandardDeviation() {
      return ExponentialDistribution.getStandardDeviation (lambda);
   }
    ...
    * 
    */
   public static ExponentialDistribution getInstanceFromMLE (double[] x, int n) {
      double parameters[] = getMLE (x, n);
      return new ExponentialDistribution (parameters[0]);
   }
