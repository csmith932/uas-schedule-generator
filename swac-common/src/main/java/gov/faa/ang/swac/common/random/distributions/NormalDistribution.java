...
protected double mu;
   ...
   /**
    * Constructs a <TT>NormalDistribution</TT> object with default parameters <SPAN CLASS="MATH"><I>&#956;</I> = 0</SPAN>
    *  and 
   ...
   /**
    * Constructs a <TT>NormalDistribution</TT> object with mean <SPAN CLASS="MATH"><I>&#956;</I></SPAN> = <TT>mu</TT>
   ...
   public double getMean() {
      return NormalDistribution.getMean (mu, sigma);
   }

   public double getVariance() {
      return NormalDistribution.getVariance (mu, sigma);
   }

   public double getStandardDeviation() {
      return NormalDistribution.getStandardDeviation (mu, sigma);
   }
