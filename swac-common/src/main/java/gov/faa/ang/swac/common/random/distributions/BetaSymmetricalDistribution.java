 ...
 * 
 */
public class BetaSymmetricalDistribution extends BetaDistribution {
    ...
    * 
    */
   public BetaSymmetricalDistribution (double alpha) {
      super(alpha, alpha);
      setParams (alpha, 14);
   }
    ...
    * 
    */
   public BetaSymmetricalDistribution (double alpha, int d) {
      super(alpha, alpha, d);
      setParams (alpha, d);
   }
    ...
    */
   {
      ...
      return NormalDistribution.cdf01 (z);
   }
   ...
   private static double PeizerInverse (double alpha, double u)
   {
      ...
      final double z = NormalDistribution.inverseF01 (u);
      double x = 0.5;
      double y = 1.0 - x;
      int i = 0;
   ...
   public double getVariance() {
      return BetaSymmetricalDistribution.getVariance (alpha);
   }

   public double getStandardDeviation() {
      return BetaSymmetricalDistribution.getStandardDeviation (alpha);
   }
   ...
   private void setParams (double alpha, int d) {
      ...
      double [] bc = new double[] {0.0, 0.0, 0.0};
      CalcB4 (alpha, bc, EPSARRAY[d]);
      double Beta = bc[0]; logBeta = bc[1]; logCeta = bc[2];
