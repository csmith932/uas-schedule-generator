 ...
 * 
 */
public class StudentDistribution extends ContinuousDistribution {
   protected int n;
...
*/
   ...
   private static double cdfGaver (int n, double x) {
      ...
      double u = NormalDistribution.cdf01 (z);
      if (x >= 0.0)
         return 1.0 - u;
      return u;
   }
   ...
   private static double invGaver (int n, double u) {
      ...
      // \cite{tGAV84a}
      double z = NormalDistribution.inverseF01 (u);
      double q = z / (n - 1.0);
      double v = q * q * (n - 1.5);
      double t = Math.sqrt(n * Math.expm1(v));
      if (u >= 0.5)
   ...
   public double getMean() {
      return StudentDistribution.getMean (n);
   }

   public double getVariance() {
      return StudentDistribution.getVariance (n);
   }

   public double getStandardDeviation() {
      return StudentDistribution.getStandardDeviation (n);
   }
   ...
   public static double cdf (int n, double x) {
      ...
      if (n == 1)
         return CauchyDistribution.cdf(0, 1, x);
      ...
      if (n == 2)
         return z;
      return BetaSymmetricalDistribution.cdf (0.5*n, 15, z);
   }
   ...
   public static double barF (int n, double x) {
      ...
      if (n == 1)
         return CauchyDistribution.barF(0, 1, x);
   ...
   public static double inverseF (int n, double u) {
        ...
        if (1 == n)
           return CauchyDistribution.inverseF(0, 1, u);
        ...
        if (n > NLIM1)
           return invGaver(n, u);
        double z = BetaSymmetricalDistribution.inverseF (0.5*n, u);
    ...
    * 
    */
   public static StudentDistribution getInstanceFromMLE (double[] x, int m) {
      double parameters[] = getMLE (x, m);
      return new StudentDistribution ((int) parameters[0]);
   }
   ...
   public static double getStandardDeviation (int n) {
      return Math.sqrt (StudentDistribution.getVariance (n));
   }
