 ...
 * 
 */
public class TriangularDistribution extends ContinuousDistribution {
   ...
   /**
    * Constructs a <TT>TriangularDistribution</TT> object with default parameters
   ...
   /**
    * Constructs a <TT>TriangularDistribution</TT> object with parameters <SPAN CLASS="MATH"><I>a</I> = 0</SPAN> ,
    *  <SPAN CLASS="MATH"><I>b</I> = 1</SPAN> and <SPAN CLASS="MATH"><I>m</I></SPAN> = <TT>m</TT>.
    * 
    */
   public TriangularDistribution (double m) {
      setParams (0.0, 1.0, m);
   }


   /**
    * Constructs a <TT>TriangularDistribution</TT> object with
    *    parameters <SPAN CLASS="MATH"><I>a</I></SPAN>, <SPAN CLASS="MATH"><I>b</I></SPAN> and <SPAN CLASS="MATH"><I>m</I></SPAN>.
    * 
    */
   public TriangularDistribution (double a, double b, double m) {
      setParams (a, b, m);
   }
   ...
   public void setMode(String m){
	   this.mode = Double.parseDouble(m);
   }
...
public double getMin() {
   ...
   public double density (double x) {
      return density (min, max, mode, x);
   }
       
   public double cdf (double x) {
      return cdf (min, max, mode, x);
   }

   public double barF (double x) {
      return barF (min, max, mode, x);
   }
     
   public double nextDouble (Random rng){
      return inverseF (min, max, mode, rng.nextDouble());
   }
   
   public double nextDouble (double u){
	  return inverseF (min, max, mode, u);
   }

   public double getMean() {
      return TriangularDistribution.getMean (min, max, mode);
   }

   public double getVariance() {
      return TriangularDistribution.getVariance (min, max, mode);
   }

   public double getStandardDeviation() {
      return TriangularDistribution.getStandardDeviation (min, max, mode);
   }
    ...
    * 
    */
   public static TriangularDistribution getInstanceFromMLE (double[] x, int n,
                                                    double a, double b) {
      double param[] = getMLE (x, n, a, b);
      return new TriangularDistribution (a, b, param[0]);
   }
   ...
   public static double getStandardDeviation (double a, double b, double m) {
      return Math.sqrt (TriangularDistribution.getVariance (a, b, m));
   }
   ...
   public String toString () {
      return getClass().getSimpleName() + " : a = " + min + ", b = " + max + ", m = " + mode;
   }
