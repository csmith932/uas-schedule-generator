 ...
 * 
 */
public class JohnsonSBDistribution extends ContinuousDistribution {
...
/**
    ...
    * 
    */
   public JohnsonSBDistribution (double gamma, double delta,
   ...
   public DistributionType getDistributionType(){
	   return DistributionType.JOHNSONSB;
   }
   ...
   public String getDistributionDescription(){
	   return "J("+lambda+","+delta+","+xi+","+gamma+")";
   }   
   
   public double nextDouble(Random rng){
	   return inverseF(rng.nextDouble());
   }
   ...
   public static double cdf (double gamma, double delta,
      ...
      if (x >= xi+lambda)
         return 1.0;
      double y = (x - xi)/lambda;
      return NormalDistribution.cdf01 (gamma + delta*Math.log (y/(1.0 - y)));
   }
   ...
   public static double barF (double gamma, double delta,
      ...
      if (x >= xi+lambda)
         return 0.0;
      double y = (x - xi)/lambda;
      return NormalDistribution.barF01 (gamma + delta*Math.log (y/(1.0 - y)));
   }
   ...
   public static double inverseF (double gamma, double delta,
      ...
      z = NormalDistribution.inverseF01 (u);
      v = (z - gamma)/delta;
